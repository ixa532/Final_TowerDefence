...
public class Bullet : MonoBehaviour
{
    ...
    public void SetTarget(Transform _target) //Método publico que aceita um transform como paramêtro
    {
    ...
    {
        if (!target) return;//Verifica se o alvo é nulo; se for, vai sair do método sem executar o restante do código 
